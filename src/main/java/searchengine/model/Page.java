...
@NoArgsConstructor
@Entity
@Table(name = "page", schema = "search_engine", indexes = @javax.persistence.Index(columnList = "path"))
public class Page {                            // implements Serializable
    ...
    private Site siteEBySiteId;

    @OneToMany(mappedBy = "pageByPageId", cascade = CascadeType.ALL)
    private List<Index> indexByPageId = new ArrayList<>();
